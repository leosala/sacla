...
def download_run(current_run):
    ...
    if os.path.isfile(data_file):
        ...
        print 'MakeTagList -b %d -r %06d -inp %s -out %s' % (
        beamline, current_run, maketaglist_condition_file, taglist_file)

        # Call DataConvert4
        # DataConvert4 -f test1017.conf -l tag_number1017.list -dir ./ -o test1017.h5
        print 'DataConvert4 -f %s -l %s -dir %s -o %06d.h5' % (
        dataconvert_config_file, taglist_file, tmp_data_directory, current_run)
