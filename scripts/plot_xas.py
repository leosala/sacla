...
t0 = 221 # delay t0
#IsData = logical(IsXray(:) & DAQ.X2Up > 0.1 & DAQ.X2Up <  0.273 & DAQ.X2Down > 0.09 & DAQ.X2Down <  0.224 & DAQ.X2Left > 0.025 & DAQ.X2Left <  0.064 & DAQ.X2Right > 0.057 & #DAQ.X2Right <  0.134);
