...
def imgAna(rname,roi,bkgRoi, n=-1):
    ...
    # creatImagesProcessore an AnalysisProcessor object
    ...
    an.add_preprocess("subtract_correction", args={"sub_image": dark})
    an.add_preprocess("set_thr", args={"thr_low": thr})
      
    # ANALYSIS FUNCTIONS
    an.add_analysis("get_mean_std") #, args={'thr_low': thr})
    bins = np.arange(-50, 600, 2)
    an.add_analysis("get_histo_counts", args={'bins': bins, 'roi':roi})
    an.add_analysis("roi_bkgRoi",args={'roi':roi, 'bkg_roi':bkgRoi})
    
    
    # run the analysis
    # analyze_images(fname, n, tags)
    results = an.analyze_images(fname,n=n)
...
#        print "Imported hdf5_utilities as h5u"
        ...
        try:
            ...
            from photon_tools.plot_utilities import plot_utilities as pu
            import photon_tools.hdf5_utilities as h5u
#            print "Imported ImagesProcessor (TOOLS_DIR)"
#            print "Imported plot_utilities as pu"
#            print "Imported hdf5_utilities as h5u"
        except:
